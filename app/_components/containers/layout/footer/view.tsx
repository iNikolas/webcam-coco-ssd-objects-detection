...
const projectUrl = packageJson.repository?.url?.replace(/^git\+|\.git$/g, "");
      ...
      <footer className="footer sm:footer-horizontal items-center py-4">
        <aside className="grid-flow-col items-center">
          ...
          <p className="flex items-center gap-3">
            <span className="font-semibold">Mykola Lebid</span>
            <span>© {new Date().getFullYear()} – All rights reserved</span>
          </p>
        </aside>
        <nav className="flex gap-4 md:place-self-center md:justify-self-end">
          <a
            href="https://www.linkedin.com/in/mykola-lebid/"
            target="_blank"
          ...
          <a
            href="https://github.com/inikolas"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-primary transition-colors"
            aria-label="GitHub"
